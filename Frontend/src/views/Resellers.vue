  ...
  methods: {
    ...
    async submitForm() {
      axios
        ...
        .then(() => {
          alert("Reseller has been successfully added.");
    ...
    deletereseller(resellerid) {
      if (
        confirm(
          "Are you sure you want to permanently delete this Reseller? This cannot be undone."
        )
      ) {
                  ...
                  <td>
                    <div class="btn-group" role="group">
                      <button
                        ...
                        @click="editreseller(item.reseller_id)"
                      >
                        Update
                      </button>
                      <button
                        ...
                        @click="deletereseller(item.reseller_id)"
                      >
                        Delete
                      </button>
                    </div>
